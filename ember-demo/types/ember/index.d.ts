...
// D.R.:
//// In case users are on 2.2

// Must run with --strictThis
interface ThisType<T> {}



type ExtendsOptions<Instance, Extensions> =
    CoreObjectArguments & Extensions & ThisType<CoreObjectArguments & Instance & Extensions>;
...
interface CoreObjectArguments<T = any> {
    /**
...
declare namespace Ember {
    ...
    **/
    ...
    var CoreObject: EmberClass<CoreObject>;
    interface EmberClass<T> {
        ...
        **/
        extend<
            Statics, Instance extends Ember.CoreObject, Extensions>(
        ...
        extend<Statics, Instance extends Ember.Object, T, Extensions>(
            this: EmberClass<Instance> & Statics,
            mixin1: Mixin<T>,
            args?: Extensions & ThisType<Extensions & T & Instance>): EmberClass<Extensions & T & Instance>;


        extend<Statics, Instance extends Ember.Object, T, U, Extensions>(
            mixin1: Mixin<T>,
            mixin2: Mixin<U>,
            args?: Extensions & ThisType<Extensions & T & Instance>): EmberClass<Extensions & U & T & Instance>;
        ...
        @param [args]
        **/
        createWithMixins<Instance extends Ember.Object, T>(this: EmberClass<Instance>, args?: Mixin<T>): T & Instance;
        ...
        **/
        create<Instance extends Object, T>(this: EmberClass<Instance>, args?: T & ThisType<T & Instance>): T & Instance;
    ...
    // Static side of Ember core objects.
    //interface EmberClass<Instance extends Ember.CoreObject> {
    //    new (): CoreObject;
    //    create<Extensions>(properties?: Extensions & ThisType<Extensions & Instance>): Extensions & Instance;
    //    extend<Statics, Extensions>(
    //        this: EmberClass<Instance> & Statics,
    //        extensions?: Extensions & ThisType<Extensions & Instance>): EmberClass<Extensions & Instance> & Statics;
    //}
    ...
    **/
    ...
    interface Mixin<T = any> {
        ...
        **/
        create<E>(extension?: E): Mixin<E & T>;
        /**
        Creates an instance of the class.
        @param arguments A hash containing values with which to initialize the newly instantiated object.
        **/
        create<E1, E2, E3, E4, E5>(e1?: E1, e2?: E2, e3?: E3, e4?: E4, e5?: E5): Mixin<E5 & E4 & E3 & E2 & E1 & T>;
        detect(obj: any): boolean;
        reopen<T>(args?: {}): T;
    }
    var Mixin: Mixin<{}>;
    ...
    */
    ...
    var VERSION: string;
    interface ViewTargetActionSupport extends Mixin {
        target: any;
        actionContext: any;
    }
